...
namespace Tester {
    public partial class MainForm: Form {
        ...
        int[,] field3 = new int[10, 40] {
            ...
            {255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {255, 0,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
        ...
        int[,] field4 = new int[10, 40] {
            ...
            {0,   0,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {255, 0,   0,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {0,   0,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
            {0,   0,   0,   0,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
        };
        ...
        private void Run1_Click(object sender, EventArgs e) {
            if (PerfectClear.Running) {
                ...
                PerfectClear.SetThreads(1);
                PerfectClear.Find(fieldUsed = field1, new int[] { 6, 0, 3, 0 }, 6, 4, true, 10, false, SearchType.AllSpins, 0, false, true);
            }
        }
        ...
        private void Run2_Click(object sender, EventArgs e) {
            if (PerfectClear.Running) {
                ...
                PerfectClear.SetThreads(12);
                PerfectClear.Find(fieldUsed = field2, new int[] { 0, 6, 2, 3, 5, 4, 3, 2, 0, 6 }, 1, null, true, 8, false, SearchType.AllSpins, 0, false, true);
            }
        }
        ...
        private void Run3_Click(object sender, EventArgs e) {
            if (PerfectClear.Running) {
                ...
                Display.Text = "Started 3";

                PerfectClear.SetThreads(1);
                PerfectClear.Find(fieldUsed = field3, new int[] { 2, 6 }, 3, 4, true, 10, false, SearchType.AllSpins, 0, false, true);
            }
        }
        ...
        private void Run4_Click(object sender, EventArgs e) {
            if (PerfectClear.Running) {
                ...
                Display.Text = "Started 4";

                PerfectClear.SetThreads(1);
                PerfectClear.Find(fieldUsed = field4, new int[] { 5, 4 }, 3, 2, true, 10, false, SearchType.AllSpins, 0, false, true);
            }
        }
    }
}
